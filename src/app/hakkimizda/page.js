        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              ...
              <div className="w-20 h-1 bg-linear-to-r from-blue-600 to-blue-400 mb-8"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl p-10 hover:shadow-2xl transition">
              <div className="bg-linear-to-br from-blue-600 to-blue-700 w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-linear-to-br from-blue-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition text-center"
              >
