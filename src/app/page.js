          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900 leading-tight">
                Aracınız <span className="text-blue-600">Güvenli Ellerde</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center bg-linear-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-xl hover:shadow-2xl transition transform hover:scale-105 font-semibold text-lg"
                >
                ...
                <a
                  href="#hizmetler"
                  className="inline-flex items-center justify-center border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-xl hover:bg-blue-50 transition font-semibold text-lg"
                >
                  Hizmetlerimiz
                </a>
              </div>
            ...
            <div className="relative animate-fade-in-delay">
              <div className="absolute inset-0 bg-linear-to-br from-blue-400 to-blue-600 rounded-3xl transform rotate-3"></div>
              <Image
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-linear-to-br from-blue-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+905359898350"
              className="inline-flex items-center justify-center bg-blue-700 text-white px-10 py-5 rounded-xl hover:shadow-2xl transition transform hover:scale-105 font-bold text-lg"
            >
